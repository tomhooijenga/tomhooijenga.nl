...
var segments = [
    ...
    // Border
    {a: {x: 0, y: 0}, b: {x: window.innerWidth, y: 0}},
    {a: {x: window.innerWidth, y: 0}, b: {x: window.innerWidth, y: window.innerHeight}},
    {a: {x: window.innerWidth, y: window.innerHeight}, b: {x: 0, y: window.innerHeight}},
    {a: {x: 0, y: window.innerHeight}, b: {x: 0, y: 0}},
